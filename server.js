    ...
    try {
        ...
        bot.onText(/\/start/, (msg) => {
            ...
            const message = 
                ...
                `Ваш Chat ID: \`${chatId}\`\n\n` +
                `Нажмите кнопку ниже, чтобы скопировать Chat ID.\n` +
        ...
        bot.on('callback_query', (callbackQuery) => {
            ...
            if (data === 'copy_chat_id') {
                ...
                bot.answerCallbackQuery(callbackQuery.id, {
                    text: 'Chat ID скопирован! Теперь вставьте его на сайте.',
                    show_alert: false
                });
                
                // Отправляем Chat ID отдельным сообщением для удобного копирования
